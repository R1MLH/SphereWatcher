...
namespace Projet_IMA
{
    static class ProjetEleve
    {
        ...
        public static void Go()
        {
            ...
            Sphere sphere1 = new Sphere("test.jpg", "bump38.jpg", new V3(400.0f, 0, 300.0f), 200.0f);
            ...
            Lumiere key = new Lumiere(blanc, 0.6f, new V3(1.0f, -1.0f, 1.0f));
            scene1.AddLampe(key);
            Lumiere fill = new Lumiere(blanc, 0.2f, new V3(-1.0f, -1.0f, 1.0f));
